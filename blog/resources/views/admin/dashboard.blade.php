                                ...
                                <tbody>
                                        @foreach($popular_posts as $key=>$post)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-primary" target="_blank" href="{{ route('post.details',$post->slug) }}">
                                                        View
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <tbody>
                                    @foreach($active_authors as $key=>$authors)
                                        <tr>
                                            <td>
                                                {{ $key+1 }}
                                            </td>
                                            ...
                                            <td>
                                                {{ $authors->comments_count}}
                                            </td>
                                            <td>
                                                {{ $authors->favorite_posts_count}}
                                            </td>
                                        </tr>
                                    @endforeach
